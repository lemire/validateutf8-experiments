...
namespace simd {
  ...
  struct simd8<bool>: base8<bool> {
    ...
    really_inline simd8() : base8() {}
    really_inline simd8(const __m128i _value) : base8<bool>(_value) {}
    // Splat constructor
    really_inline simd8(bool _value) : base8<bool>(splat(_value)) {}
...
#endif // FASTVALIDATE_WESTMERE_SIMD_INPUT_H
