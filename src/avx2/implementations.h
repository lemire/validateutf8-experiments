...
really_inline bool is_two_byte(simd8x64<uint8_t> input, simd8<uint8_t> prev) {
  simd8<uint8_t> bits = input.reduce_or() | prev;
  return bits.saturating_sub(0b11100000u-1).bits_not_set_anywhere();
}
really_inline simd8<bool> must_be_continuation(simd8<uint8_t> prev1, simd8<uint8_t> prev2, simd8<uint8_t> prev3) {
  simd8<uint8_t> is_second_byte = prev1.saturating_sub(0b11000000u-1); // Only 11______ will be > 0
  simd8<uint8_t> is_third_byte  = prev2.saturating_sub(0b11100000u-1); // Only 111_____ will be > 0
...
#include "generic/utf8_lookup5_algorithm.h"
}
